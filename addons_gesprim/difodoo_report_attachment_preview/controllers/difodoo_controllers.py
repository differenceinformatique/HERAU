...
# Report Controllers #
######################
class DifodooReportController(ReportController):

    @http.route(['/report/download'], type='http', auth="user")
    def report_download(self, data, token):
        res = super(DifodooReportController, self).report_download(data, token)
...
# Binary Controllers #
######################
class DifodooBinaryController(Binary):
    ...
    def content_common(self, xmlid=None, model='ir.attachment', id=None, field='datas',
        ...
        res = super(DifodooBinaryController, self).content_common(xmlid=xmlid, model=model, id=id, field=field,
